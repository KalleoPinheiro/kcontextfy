...
url: "https://akitaonrails.com/2026/05/14/terminando-maratona-ia-sucesso-ou-fracasso/"
type: "article"
...
*14 de maio de 2026* · [💬 Participe da Discussão][1]

*Se tem preguiça de ler, clique [aqui][2] pro TL;DR*
...
### Tier de cima (7-8/10)[][6]

**[ai-jail][7] — 8/10.** O único que está bem próximo de uma release estável 1.0. Foi o que teve mais tração: 19 PRs fechadas, 23 Issues resolvidas. Recomendo usar, funciona muito bem.
...
**[akitaonrails.github.io][8] — 7/10.** É este blog. Mexo com frequência e já fechei umas 7 Issues e 30 PRs de contribuidores. Continuo ajustando aos poucos.

**[FrankMD][9] — 7/10.** Foi um dos primeiros que fiz, sem critério nenhum: só queria um editor que tivesse upload automático de imagem pro meu S3. Hoje uso Claude Code pra editar os posts, então só quem contribui é quem usa. Esse teve bastante tração, fechei 17 PRs e 29 Issues. Não é perfeito, mas está bom pra usar, pelo menos foi testado o suficiente.

**[easy-ffmpeg][10] — 7/10.** Projetinho pequeno, mas esse eu uso de fato nos vídeos. Meu OBS sempre grava em MKV e, quando quero compartilhar, converto pra MP4. Casos de uso pequenos assim. Está bom o suficiente pra usar.

### Tier do meio (5/10)[][11]

**[distrobox-gaming][12] — 5/10.** É o mais recente, serve como “dump” de documentação dos meus retrogames. Uso como bloco de anotações e tem funcionado bem pro meu setup. Não estou preocupado que funcione pra mais ninguém. Quem quiser, manda PR.

**[llm-coding-benchmark][13] — 5/10.** Esse projeto não roda sozinho. Eu mando o Claude Code executar ele. O objetivo é tabular dados pra escrever os artigos sobre LLMs novas. O código deve estar BEM ruim.

**[FrankMega][14] — 5/10.** É o mais próximo de um exercício “todo list”. Eu só precisava compartilhar um arquivo grande com um amigo e pensei “hum, aposto que dá pra fazer um mini-mega em 1 dia”. Foi isso. O nome é brincadeira, de jeito nenhum chega perto do Mega de verdade, óbvio.

**[distrobox-llm][15] — 5/10.** Mais organização pessoal do meu PC: queria separar as ferramentas de IA num distrobox pra não ficar atualizando pacote grande toda hora.

### Tier de baixo (3-4/10)[][16]

**[FrankYomik][17] — 4/10.** Essa era uma ideia na minha cabeça há anos. Só queria ver se o conceito funcionava. Funciona. Mas rodar LLMs locais pra isso é lento e não tão prático quanto eu gostaria. É o único que ainda devo voltar pra mexer mais, porque realmente quero usar. No estado atual, está em “funciona, mais ou menos”.

**[NW-Omarchy][18] — 4/10.** Outro experimento de “será que dá?”, que durou 2 dias. O conceito funcionou, mas não pretendo fazer muito mais que isso. Fica pra quem tiver interesse de continuar. Na prática eu quis testar se em X11 ficaria MUITO mais ruim que em Wayland. O gap é menor do que eu esperava, mas realmente não me vejo usando no dia a dia. Como já falei, pro nicho de pessoas que não tem como usar Wayland, é uma boa alternativa.

**[frank\_investigator][19] — 3/10.** Comecei, mas não tive saco pra continuar. Plantei as sementes da ideia. Se ninguém mandar PR, vai evoluir pouco. Precisa de mais pesquisa e muito mais teste.

**[frank\_fbi][20] — 3/10.** Mais um que quis testar o conceito, sem uso pessoal — nunca caí em phishing. Não sei pra onde levaria isso ainda.

**[frank\_karaoke][21] — 3/10.** Nasceu de uma conversa de fim de semana com meus irmãos. Mais uma tentativa de usar Flutter (e ver como tem limitação tanto no Flutter quanto nas LLMs usando Flutter). Serviu pra eu aprender sobre o ecossistema de karaokê e descobrir que pontuação de verdade só com metadado específico por música. Então não avancei muito além de brinquedo.

### Fundo do poço (1-2/10)[][22]

**[FrankSherlock][23] — 2/10.** Eu mesmo não uso. Por isso deve estar cheio de bug que precisa de correção. Foi teste pra ver se dava pra fazer um app Tauri, mas perdi o interesse rápido. Ainda dá pra melhorar, mas precisa de muito mais horas de uso, testes e correções. Foi a primeira vez que usei Tauri, então essa parte deve estar bem ruim também.

**[FrankClaw][24] — 1/10.** Eu mesmo não uso, e esse é o único que eu nem rodei uma única vez. O exercício foi só ver a dificuldade de traduzir o openclaw original de TypeScript pra Rust. Mas, como já postei várias vezes, não vejo utilidade no openclaw pra mim. Quando terminei a versão 0.1, parei. Ainda assim teve 6 PRs que fechei. Se alguém estiver interessado, pode contribuir.

**[shadPS4][25] — 1/10.** Apesar de ter gerado muito código e muita documentação, nada foi pensado em virar contribuição. Foi exclusivamente aprendizado e pra resolver um problema muito específico. Deixei aberto pra mostrar como código puramente de material de estudo se parece.

**[easy-subtitle][26] — 1/10.** Comecei, perdi o interesse, nunca parei pra testar de verdade. Só dei push e esqueci.
...
## O resumo do aprendizado dessa maratona[][29]
...
[1]: #disqus_wrapper
[2]: https://chatgpt.com/?hints=search&q=Por+favor%2C+abra+esta+URL+com+busca+na+web+e+leia+o+artigo+completo%3A+https%3A%2F%2Fwww.akitaonrails.com%2F2026%2F05%2F14%2Fterminando-maratona-ia-sucesso-ou-fracasso%2F%0A%0ADepois+de+ler+o+conte%C3%BAdo+real+do+artigo%2C+fa%C3%A7a+o+seguinte%3A%0A1%29+Resuma+os+5+pontos+mais+importantes+e+a+conclus%C3%A3o.%0A2%29+Depois+do+resumo%2C+diga+ao+leitor+quais+detalhes%2C+dados+e+insights+ele+est%C3%A1+perdendo+por+n%C3%A3o+ler+o+artigo+completo.+Seja+espec%C3%ADfico+o+suficiente+pra+deixar+ele+curioso.%0A3%29+Lembre+que+ele+pode+continuar+fazendo+perguntas+sobre+o+artigo+aqui+neste+chat.%0A4%29+Sugira+uma+boa+pergunta+de+follow-up+que+ele+poderia+fazer+pra+come%C3%A7ar.
[3]: /2020/05/15/a-dor-de-aprender/
[4]: /2020/05/16/guia-definitivo-de-aprendendo-a-aprender/
[5]: #o-ranking-dos-projetos
[6]: #tier-de-cima-7-810
[7]: https://github.com/akitaonrails/ai-jail
[8]: https://github.com/akitaonrails/akitaonrails.github.io
[9]: https://github.com/akitaonrails/FrankMD
[10]: https://github.com/akitaonrails/easy-ffmpeg
[11]: #tier-do-meio-510
[12]: https://github.com/akitaonrails/distrobox-gaming
[13]: https://github.com/akitaonrails/llm-coding-benchmark
[14]: https://github.com/akitaonrails/FrankMega
[15]: https://github.com/akitaonrails/distrobox-llm
[16]: #tier-de-baixo-3-410
[17]: https://github.com/akitaonrails/FrankYomik
[18]: https://github.com/akitaonrails/NW-Omarchy
[19]: https://github.com/akitaonrails/frank_investigator
[20]: https://github.com/akitaonrails/frank_fbi
[21]: https://github.com/akitaonrails/frank_karaoke
[22]: #fundo-do-po%C3%A7o-1-210
[23]: https://github.com/akitaonrails/FrankSherlock
[24]: https://github.com/akitaonrails/FrankClaw
[25]: https://github.com/akitaonrails/shadPS4
[26]: https://github.com/akitaonrails/easy-subtitle
[27]: #os-privados
[28]: #o-que-esse-ranking-diz
[29]: #o-resumo-do-aprendizado-dessa-maratona
[30]: #o-ponto-que-mais-importa