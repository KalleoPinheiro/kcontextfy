...
## O que o vazamento do Claude Code mostrou[][1]

Antes de entrar na parte teórica, vale falar de algo que aconteceu há poucos dias e que reforça muito essa discussão. Em 31 de março de 2026, a Anthropic, sem querer, publicou no npm a versão 2.1.88 do pacote `@anthropic-ai/claude-code` com um source map de quase 60 MB anexado, e cerca de 512 mil linhas de TypeScript da ferramenta interna deles vazaram pro mundo. Eu já tinha [escrito sobre o incidente na semana passada][2], com mais detalhe sobre o que apareceu no código.
...
## Onde a história começou a virar[][6]
...
## Prós e contras de cada lado[][10]

### RAG clássico (vector DB)[][11]
...
No [meu artigo do benchmark de LLMs de ontem][7] eu mapeei o preço por token de cada modelo. Pega o Claude Sonnet 4.6: $3 por milhão de tokens de input, $15 por milhão de output. Pega o GLM 5 (que provei que funciona): $0.60 input, $2.20 output. Pega o GPT 5.4 Pro lá em cima: $15 input, $180 output (esse aí machuca, eu sei).
...
## Os pontos onde a tese não cola[][15]
...
## Lazy retrieval: a receita que eu defendo[][16]
...
## Uma implementação de brinquedo em Ruby[][17]

Pra deixar concreto. Eis um script Ruby usando o gem [`ruby_llm`][18] (o mesmo do benchmark de ontem) que faz exatamente esse fluxo: grep nos arquivos, carrega os trechos com contexto, manda pro Claude, recebe a resposta. Sem vector DB, sem chunking, sem embedding, sem LangChain.
...
## O que a literatura recente diz[][2]
...
- Li, Z. et al. (2024). [Retrieval Augmented Generation or Long-Context LLMs? A Comprehensive Study and Hybrid Approach][3]. EMNLP 2024 Industry Track.
- Yuan, K. et al. (2025). [LaRA: Benchmarking Retrieval-Augmented Generation and Long-Context LLMs – No Silver Bullet for LC or RAG Routing][4]. ICML 2025.
- Yu, T. et al. (2025). [Long Context vs. RAG for LLMs: An Evaluation and Revisits][5]. arXiv:2501.01880.
- Liu, N. F. et al. (2023). [Lost in the Middle: How Language Models Use Long Contexts][6]. TACL 2024.
- Thakur, N. et al. (2021). [BEIR: A Heterogenous Benchmark for Zero-shot Evaluation of Information Retrieval Models][7]. NeurIPS Datasets and Benchmarks 2021.
- Anthropic (2024). [Introducing Contextual Retrieval][8]. Blog técnico.
- Akita, F. (2026). [O código fonte do Claude Code vazou. O que achamos dentro.][10] — minha cobertura do leak, com mais detalhe sobre arquitetura de memória, KAIROS e `autoDream`.

[1]: #o-ponto-que-importa
[2]: #o-que-a-literatura-recente-diz
[3]: https://arxiv.org/abs/2407.16833
[4]: https://openreview.net/forum?id=CLF25dahgA
[5]: https://arxiv.org/abs/2501.01880
[6]: https://arxiv.org/abs/2307.03172
[7]: https://arxiv.org/abs/2104.08663
[8]: https://www.anthropic.com/news/contextual-retrieval
[9]: #fontes
[10]: https://akitaonrails.com/2026/03/31/codigo-fonte-do-claude-code-vazou-o-que-achamos-dentro/
